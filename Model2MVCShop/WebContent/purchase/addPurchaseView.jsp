...
function fncAddPurchase() {
	...
	if(divyDate == null){
		alert("배송 희망일자를 선택해주세요.");
		return;
	}
	
	//document.addPurchase.submit();
	$("form").attr("method" , "POST").attr("action" , "/purchase/addPurchase?userId=${user.userId}").submit();
...
<%-- <form name="addPurchase" method="post" action="/purchase/addPurchase?userId=${user.userId}"> --%>
